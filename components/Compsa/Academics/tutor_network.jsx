  ...
  return (
    <div>
      <div className="bg-[#EEEBFD]">
        <h1 className="font-inter font-bold tracking-wider text-[#553ADD] text-center text-3xl pt-5 pb-5">
          TUTOR NETWORK
        </h1>
      </div>
      <div className="bg-[#FCFCFC]">
        <div className="flex flex-row justify-around pt-16 items-center">
          ...
          <div className="bg-[#EEEBFD] rounded-3xl px-8 pt-3 pb-3 w-1/3">
            <h2 className="font-inter font-bold text-xl tracking-wider text-[#553ADD]">
              Tutor Name
            </h2>
            <h5 className="font-inter font-bold text-md tracking-wide mt-2">
              Offered Courses:
            </h5>
            <h5 className="font-inter font-normal text-md tracking-wider">
              MISC 000, MISC 000, MISC 000
            </h5>
            <h5 className="font-inter font-bold text-md tracking-wide">
              Price: $XX/hour
            </h5>
          </div>
          <div className="bg-[#EEEBFD] rounded-3xl px-8 pt-3 pb-3 w-1/3">
        ...
        <div className="flex flex-row justify-around pt-4 pb-16 items-center">
          ...
          <div name="tutor" className="bg-[#553ADD] rounded-xl py-3 pb-3 w-1/3">
            <h2 className="font-inter font-bold text-xs tracking-wider text-[#FFFFFF] text-center md:text-lg">

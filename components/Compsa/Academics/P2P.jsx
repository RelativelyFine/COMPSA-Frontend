...
const P2P = () => {
  return (
    <div className="bg-[#FCFCFC]">
      <h1 className="font-inter font-bold tracking-wider text-[#553ADD] text-center text-3xl pt-8">
        P2P MENTORSHIP PROGRAM
      </h1>
      <h3 className="font-inter font-normal text-center text-[#200263] text-lg pt-3 pb-12">
      ...
      <div className="flex justify-center items-center flex-wrap mb-8 gap-10">
        <div className="bg-[#DAD2FF] rounded-lg pl-5 py-5 w-1/2 h-52">
          <h3 className="font-inter font-bold tracking-wide text-[#200263] text-lg">
            WHAT IS P2P?
          </h3>
          <text className="font-inter font-normal text-[#200263] text-sm">
            Insert bio here
          </text>
        </div>
      ...
      <div className="flex justify-center pb-12">
        <Link href="/" className="bg-[#553ADD] rounded-2xl w-1/2">
          <h3 className="text-center text-[#EEEBFD] font-inter font-bold tracking-wide text-2xl pt-4 sm:text-md">
            P2P Mentorship Application
          </h3>
          <h5 className="text-center text-[#A897FF] font-inter font-bold tracking-wider text-sm pb-4 pt-1">
            OCTOBER / 04 / 2022
          </h5>
        </Link>
      </div>
